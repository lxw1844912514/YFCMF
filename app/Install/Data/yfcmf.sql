...
CREATE TABLE IF NOT EXISTS `yf_member_list` (
  ...
  `member_list_from` varchar(20) NOT NULL DEFAULT '' COMMENT '本地为空',
...
CREATE TABLE IF NOT EXISTS `yf_oauth_user` (
  ...
  `user_status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0=未激活 1=激活',
