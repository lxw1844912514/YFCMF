...
class WebLog extends Base {
    ...
    public function weblog_setting(){
		...
		//模块
		$web_log['not_log_module']=$web_log['not_log_module']?join(',',$web_log['not_log_module']):'';
		$web_log['not_log_controller']=$web_log['not_log_controller']?join(',',$web_log['not_log_controller']):'';
		$web_log['not_log_action']=$web_log['not_log_action']?join(',',$web_log['not_log_action']):'';
		$web_log['not_log_data']=$web_log['not_log_data']?join(',',$web_log['not_log_data']):'';
		$web_log['not_log_request_method']=$web_log['not_log_request_method']?join(',',$web_log['not_log_request_method']):'';
		//控制器 模块
		$controllers=array();
		$actions=array();
		$modules=['home','admin'];
