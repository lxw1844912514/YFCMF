...
window.ShearPhoto.MINGGE(function() {
		...
		var cm1=serverdata[0]["ImgUrl"];
		var cm2=serverdata[1]["ImgUrl"];
		var cm3=serverdata[2]["ImgUrl"];
                   ...
                   //alert(serverdata);//你可以调试一下这个返回包
                    ...
                    xmlhttp.open("POST","HTTP://127.0.0.1/slackck/index.php/Member/member_list_userpic",true);
                    xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
                    xmlhttp.send("member_list_id=1&cm1="+cm1);
